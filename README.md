...
Generate your own cartoon-style images with [CartoonGAN (CVPR 2018)](http://openaccess.thecvf.com/content_cvpr_2018/papers/Chen_CartoonGAN_Generative_Adversarial_CVPR_2018_paper.pdf), powered by TensorFlow 2.1
...
```bash
git clone https://github.com/infynite/CartoonGan-tensorflow.git
```
...
If you don't want to train a CartoonGAN yourself (but want to generate anime anyway), you can simply run [this colab notebook](https://colab.research.google.com/drive/1_z2R_wq2APmSUhGmaD7uu_k9uMOsLBFD?usp=sharing).
